...
const MyModalPost: React.FC<MyModalProps> = ({ isOpen, onClose }) => {
        ...
        try {
            postTransaction(modalData)
                .then((response) => {
                    ...
                    queryClient.invalidateQueries(['food-extrato'])
                });
        } catch (error) {
                ...
                {(onClose) => (
                    ...
                    <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                        <Input
                            ...
                            onValueChange={setAgency} value={agency}
                        ...
                        <Input
                            ...
                            isRequired isDisabled={isPosting}
                            onValueChange={setAccount} value={account}
                        />
                    </div>
                    <Divider/>
                    <Input
